        ...
        <div className="px-6 py-20 md:px-20 md:py-20  text-bluetiful" id="about">
            ...
            <section className="md:flex md:flex-row">
                    <div className="md:w-6/12">
                        <div data-aos="fade-up" className="w-full flex flex-row justify-center items-center" style={{'height': '300px', 'width': '300px'}}>
                            <Image src="/svg/card_banner.svg" width="auto" height="auto"/>                            
                        </div>
                        <h3 data-aos="fade-up"  className="text-2xl font-bold">Unique Identity</h3>
                        <p data-aos="fade-up"  className="text-royal-dark-blue">
                    ...
                    <div className="md:w-6/12">
                        ...
                        <h3 data-aos="fade-up"  className="text-2xl font-bold">Data Integrity</h3>
                        <p data-aos="fade-up"  className="text-royal-dark-blue">
